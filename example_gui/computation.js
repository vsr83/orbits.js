...
function processMoon(configuration, timeStamp)
{
    ...
    let moonPosEq = orbitsjs.elp2000(JTtdb);
    const lightTimeSecs = orbitsjs.norm(moonPosEq) / 3.0e8;
    moonPosEq = orbitsjs.elp2000(JTtdb - lightTimeSecs/86400.0);
